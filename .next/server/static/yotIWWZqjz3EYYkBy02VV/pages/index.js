...
var creators_getProgress = function getProgress() {
  return function (dispatch) {
    var url = "".concat("https://letter-from-humanity-api-prod.herokuapp.com/", "/stats");
    dispatch({
    ...
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", external_axios_default.a.post("https://letter-from-humanity-api-prod.herokuapp.com/" + '/signatures/', _objectSpread({}, values)).catch(function (err) {
